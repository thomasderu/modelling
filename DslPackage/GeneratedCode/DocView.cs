...
namespace Company.TestMart
{
	...
	/// </summary>
	internal partial class TestMartDocView : TestMartDocViewBase
	{
		/// <summary>
		/// Constructs a new TestMartDocView.
		/// </summary>
		public TestMartDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class TestMartDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new TestMartDocView.
		/// </summary>
		protected TestMartDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			TestMartDocDataBase docData = this.DocData as TestMartDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for TestMartDocViewBase should be an TestMartDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.TestMart.TestMartDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.TestMart.TestMartDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.TestMart.TestMartToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.TestMart.TestMartToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.TestMartDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.TestMart.TestMartHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.TestMart.TestMartHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.TestMart.TestMartHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
