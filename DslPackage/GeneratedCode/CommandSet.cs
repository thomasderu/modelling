...
namespace Company.TestMart
{
	...
	/// </summary>
	internal partial class TestMartCommandSet : TestMartCommandSetBase
	{
		/// <summary>
		/// Constructs a new TestMartCommandSet.
		/// </summary>
		public TestMartCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class TestMartCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new TestMartCommandSetBase.
		/// </summary>
		protected TestMartCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewTestMartExplorerCommand,
				typeof(TestMartEditorFactory).GUID);
		...
		{
			TestMartExplorerToolWindow explorer = this.TestMartExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected TestMartDocData CurrentTestMartDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as TestMartDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected TestMartDocView CurrentTestMartDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as TestMartDocView;
			}
		}
		...
		/// </summary>
		protected TestMartExplorerToolWindow TestMartExplorerToolWindow
		{
			get
			{
				TestMartExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(TestMartExplorerToolWindow), true) as TestMartExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				TestMartExplorerToolWindow explorerWindow = this.TestMartExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class TestMartClipboardCommandSet : TestMartClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new TestMartClipboardCommandSet.
		/// </summary>
		public TestMartClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class TestMartClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new TestMartClipboardCommandSetBase.
		/// </summary>
		protected TestMartClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
