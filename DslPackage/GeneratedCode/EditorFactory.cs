...
namespace Company.TestMart
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.TestMartEditorFactoryId)]
	internal partial class TestMartEditorFactory : TestMartEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new TestMartEditorFactory.
		/// </summary>
		public TestMartEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class TestMartEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected TestMartEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new TestMartDocData(this.ServiceProvider, typeof(TestMartEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new TestMartDocView(docData, this.ServiceProvider);
		}
	}
}
