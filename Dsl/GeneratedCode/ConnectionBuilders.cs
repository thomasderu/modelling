...
namespace Company.TestMart
{
	...
	/// </summary>
	public static partial class SolutionReferencesConcernsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.TestMart.Solution)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.TestMart.Solution)
				{
					if (candidateTarget is global::Company.TestMart.Concern)
					{
						global::Company.TestMart.Solution sourceSolution = (global::Company.TestMart.Solution)candidateSource;
						global::Company.TestMart.Concern targetConcern = (global::Company.TestMart.Concern)candidateTarget;
						if(targetConcern == null || global::Company.TestMart.SolutionReferencesConcerns.GetLinkToSolution(targetConcern) != null) return false;
						if(targetConcern == null || sourceSolution == null || global::Company.TestMart.SolutionReferencesConcerns.GetLinks(sourceSolution, targetConcern).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.TestMart.Solution)
				{
					if (target is global::Company.TestMart.Concern)
					{
						global::Company.TestMart.Solution sourceAccepted = (global::Company.TestMart.Solution)source;
						global::Company.TestMart.Concern targetAccepted = (global::Company.TestMart.Concern)target;
						DslModeling::ElementLink result = new global::Company.TestMart.SolutionReferencesConcerns(sourceAccepted, targetAccepted);
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class ConcernReferencesTargetConcernsBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
			...
			else // Check combinations
			{
				if (candidateSource is global::Company.TestMart.Concern)
				{
					if (candidateTarget is global::Company.TestMart.Concern)
					{
						...
						global::Company.TestMart.Concern targetConcern = (global::Company.TestMart.Concern)candidateTarget;
						if(targetConcern == null || sourceConcern == null || global::Company.TestMart.ConcernReferencesTargetConcerns.GetLinks(sourceConcern, targetConcern).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Company.TestMart.Concern)
				{
					if (target is global::Company.TestMart.Concern)
					{
						...
						global::Company.TestMart.Concern targetAccepted = (global::Company.TestMart.Concern)target;
						DslModeling::ElementLink result = new global::Company.TestMart.ConcernReferencesTargetConcerns(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// </summary>
	internal partial class EffectSolutionConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new EffectSolutionConnectAction for the given Diagram.
		/// </summary>
		public EffectSolutionConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the EffectSolutionConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new EffectSolutionConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class EffectSolutionConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the EffectSolutionConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected EffectSolutionConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder SolutionReferencesConcernsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return SolutionReferencesConcernsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return SolutionReferencesConcernsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				SolutionReferencesConcernsBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class EffectSolutionConnectionType : EffectSolutionConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the EffectSolutionConnectionType with the given ConnectionBuilder.
			/// </summary>
			public EffectSolutionConnectionType() : base() {}
		}
	}
	...
	internal partial class EffectRelationConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class EffectRelationConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder ConcernReferencesTargetConcernsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				bool canConnect = true;
				...
				{				
					if(targetShapeElement == null)
					{
						return ConcernReferencesTargetConcernsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return ConcernReferencesTargetConcernsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				DslModeling::ModelElement targetElement = targetShapeElement.ModelElement;
				if(targetElement == null) targetElement = targetShapeElement;
				ConcernReferencesTargetConcernsBuilder.Connect(sourceElement, targetElement);
			}
		}
