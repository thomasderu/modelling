...
namespace Company.TestMart
{
	...
	/// </remarks>
	public partial class TestMartHelpKeywordHelper : TestMartHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new TestMartHelpKeywordHelper.
		/// </summary>
		protected TestMartHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the TestMartHelpKeywordHelper.
		/// </summary>
		public static TestMartHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class TestMartHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new TestMartHelpKeywordHelperBase.
		/// </summary>
		protected TestMartHelpKeywordHelperBase()
			: base() { }
